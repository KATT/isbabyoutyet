...
const STAR_MESSAGE =
  'Do not `export * from "react"`. That re-exports banned hooks into feature import paths.';
...
const noBannedReactReexport = defineRule({
  meta: {
    type: "problem",
    docs: {
  ...
  create(context) {
    /** Local binding name → banned React hook name */
