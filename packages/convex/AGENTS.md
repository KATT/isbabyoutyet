...
linked from the homepage). Those babies are stored as `demo.kind: "source"`; the
refresh mutation refuses to wipe any baby missing that marker (except grandfathering
