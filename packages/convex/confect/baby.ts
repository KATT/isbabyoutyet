...
export const update = mutationWithTriggers({
  ...
  handler: async (ctx, args) => {
    ...
    // Strip deprecated stage-message args so they never land on the baby doc
    const babyId = args.babyId;
    const legacyMessages = {
      labor_started: args.laborStartedMessage,
      gone_to_hospital: args.hospitalMessage,
      born: args.babyBornMessage,
    };
    const rest: {
      laborStarted?: string | null;
      wentToHospital?: string | null;
    ...
    if (args.laborStarted !== undefined) rest.laborStarted = args.laborStarted;
    if (args.wentToHospital !== undefined) rest.wentToHospital = args.wentToHospital;
    if (args.babyBorn !== undefined) rest.babyBorn = args.babyBorn;
    if (args.dueDate !== undefined) rest.dueDate = args.dueDate;
    if (args.name !== undefined) rest.name = args.name;
    if (args.theme !== undefined) rest.theme = args.theme;
    if (args.encouragementsDisabled !== undefined) {
      rest.encouragementsDisabled = args.encouragementsDisabled;
    }
