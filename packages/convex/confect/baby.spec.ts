...
import type { listByUser, getByPublicId, generateUploadUrl, updatePhoto, create, getScheduledNotifications, cancelScheduledNotification, markNotificationSent, updateThumbnail, update } from "./baby";
...
export default GroupSpec.make()
  ...
  .addFunction(FunctionSpec.convexPublicQuery<typeof getScheduledNotifications>()("getScheduledNotifications"))
  .addFunction(FunctionSpec.convexPublicMutation<typeof cancelScheduledNotification>()("cancelScheduledNotification"))
  .addFunction(FunctionSpec.convexInternalMutation<typeof markNotificationSent>()("markNotificationSent"))
