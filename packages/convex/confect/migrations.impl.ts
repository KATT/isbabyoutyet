...
const generateThumbnailsForExistingPhotosImpl = FunctionImpl.make(
  databaseSchema,
  migrationsSpec,
  "generateThumbnailsForExistingPhotos",
  generateThumbnailsForExistingPhotos,
);
const backfillBabyTimelineImpl = FunctionImpl.make(
  databaseSchema,
  migrationsSpec,
  "backfillBabyTimeline",
  backfillBabyTimeline,
);
const backfillEncouragementTimelineImpl = FunctionImpl.make(
  databaseSchema,
  migrationsSpec,
  "backfillEncouragementTimeline",
  backfillEncouragementTimeline,
);
const separateMilestoneOccurredAtImpl = FunctionImpl.make(
  databaseSchema,
  migrationsSpec,
  "separateMilestoneOccurredAt",
  separateMilestoneOccurredAt,
