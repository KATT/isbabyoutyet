...
import { colors } from "@workspace/ui-cssinjs/lib/tokens.stylex";
...
const DrawerOverlay = (props: React.ComponentProps<typeof DrawerPrimitive.Backdrop>) => (
...
const DrawerHandle = ({ className, style, ...props }: React.ComponentProps<"div">) => (
  <div
    aria-hidden="true"
    data-slot="drawer-handle"
    {...stylex.props(styles.handle, customClassName(className), style as StyleXStyles)}
    {...props}
  />
);
...
const DrawerContent = ({
  ...
  <DrawerPrimitive.Portal>
    ...
    <DrawerPrimitive.Popup
      ...
      {...stylex.props(styles.popup, customClassName(className), style as StyleXStyles)}
      {...props}
    >
...
const DrawerHeader = ({ className, style, ...props }: React.ComponentProps<"div">) => (
  <div
...
const DrawerFooter = ({ className, style, ...props }: React.ComponentProps<"div">) => (
  <div
