...
Demo photos live in Git LFS (`products/baby-outlet/backend/assets/homepage-demo/`). Vercel: enable Git LFS in the project Git settings so production/preview builds receive the actual images.
