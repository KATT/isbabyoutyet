...
const enGB = {
  ...
  "This removes the status and deletes its timeline update, including any message or photo attached to it. This cannot be undone.": "This removes the status and deletes its timeline update, including any message or photo attached to it. This cannot be undone.",
  ...
  "Optional — leave blank for now. You can change the time later in settings.": "Optional — leave blank for now. You can change the time later in settings.",
  "Co-parents": "Co-parents",
  "People who can post updates and change settings": "People who can post updates and change settings",
  ...
  "The page will disappear from your dashboard and the public link will stop working. Only you (the owner) can do this.": "The page will disappear from your dashboard and the public link will stop working. Only you (the owner) can do this.",
  "Loading co-parents…": "Loading co-parents…",
  "Co-parent added — they can manage this page now": "Co-parent added — they can manage this page now",
  "Invite sent — they'll get access after signing up with that email": "Invite sent — they'll get access after signing up with that email",
  ...
  "No co-parents yet. Add a partner so they can post updates too.": "No co-parents yet. Add a partner so they can post updates too.",
  "Add": "Add",
  ...
  "Create an account to share your baby's arrival": "Create an account to share your baby's arrival",
  ...
  "Is": "Is",
  "out yet?": "out yet?",
  'Stop answering "any news yet?" texts. Share one link, let everyone follow along, and tell them all at once when baby arrives. 🍼': 'Stop answering "any news yet?" texts. Share one link, let everyone follow along, and tell them all at once when baby arrives. 🍼',
  "Create your page 🎈": "Create your page 🎈",
  "Everything the family needs": "Everything the family needs",
  "For you, and for everyone waiting by the phone": "For you, and for everyone waiting by the phone",
  "See it in action": "See it in action",
  "Click any stage to see how your page will look": "Click any stage to see how your page will look",
  "How it works": "How it works",
  "Get Started Free 🎉": "Get Started Free 🎉",
  "Join families who've already shared their special moments. Takes less than a minute.": "Join families who've already shared their special moments. Takes less than a minute.",
  "Update your status": "Update your status",
  "One tap to update everyone — labour started, at the hospital, baby's here! No group texts, no repeated calls.": "One tap to update everyone — labour started, at the hospital, baby's here! No group texts, no repeated calls.",
  "Countdown to due date": "Countdown to due date",
  'Everyone can see how many days are left — plus a friendly "overdue" counter when baby takes their time.': 'Everyone can see how many days are left — plus a friendly "overdue" counter when baby takes their time.',
  "Make it yours": "Make it yours",
  "Pick a theme that matches your style. From soft pastels to bold colours — your page, your vibe.": "Pick a theme that matches your style. From soft pastels to bold colours — your page, your vibe.",
  "No account needed": "No account needed",
  "Anyone with the link can check in anytime. Grandma doesn't need to download an app or create an account.": "Anyone with the link can check in anytime. Grandma doesn't need to download an app or create an account.",
  "Send encouragement": "Send encouragement",
  "Visitors can leave messages of love and support. Like a digital guestbook filled with well-wishes you'll treasure.": "Visitors can leave messages of love and support. Like a digital guestbook filled with well-wishes you'll treasure.",
  "Get notified": "Get notified",
  "Family can subscribe to push notifications and be the first to know the moment baby arrives.": "Family can subscribe to push notifications and be the first to know the moment baby arrives.",
  "Create your page": "Create your page",
  "Share the link": "Share the link",
  "Send it to family and friends. They can check in anytime and subscribe for notifications.": "Send it to family and friends. They can check in anytime and subscribe for notifications.",
  "Update as you go": "Update as you go",
  "When things start happening, update your status. Everyone gets notified automatically.": "When things start happening, update your status. Everyone gets notified automatically.",
  "At hospital": "At hospital",
  "Baby born!": "Baby born!",
  "Go Home": "Go Home",
} as const;
...
const sv: Record<TranslationKey, string> = {
  ...
  "This removes the status and deletes its timeline update, including any message or photo attached to it. This cannot be undone.": "Det tar bort statusen och raderar tidslinjeuppdateringen, inklusive meddelande eller foto. Åtgärden kan inte ångras.",
  ...
  "Optional — leave blank for now. You can change the time later in settings.": "Valfritt — lämna tomt för nu. Du kan ändra tiden senare i inställningarna.",
  "Co-parents": "Medföräldrar",
  "People who can post updates and change settings": "Personer som kan lägga upp uppdateringar och ändra inställningar",
  ...
  "The page will disappear from your dashboard and the public link will stop working. Only you (the owner) can do this.": "Sidan försvinner från översikten och den publika länken slutar fungera. Bara du (ägaren) kan göra det.",
  "Loading co-parents…": "Laddar medföräldrar…",
  "Co-parent added — they can manage this page now": "Medförälder tillagd — de kan hantera sidan nu",
  "Invite sent — they'll get access after signing up with that email": "Inbjudan skickad — de får åtkomst efter att ha registrerat sig med den e-postadressen",
  ...
  "No co-parents yet. Add a partner so they can post updates too.": "Inga medföräldrar än. Lägg till en partner så att de också kan lägga upp uppdateringar.",
  "Add": "Lägg till",
  ...
  "Add a": "Lägg till en",
  "baby": "bebis",
  "A name and a due date — that's all it takes!": "Ett namn och ett beräknat datum — det är allt som behövs!",
  "Add Baby 🍼": "Lägg till bebis 🍼",
  ...
  "Is": "Har",
  "out yet?": "kommit?",
  'Stop answering "any news yet?" texts. Share one link, let everyone follow along, and tell them all at once when baby arrives. 🍼': 'Slipp svara på "några nyheter?". Dela en länk, låt alla följa med och berätta för alla på en gång när bebisen kommer. 🍼',
  "Create your page 🎈": "Skapa din sida 🎈",
  "Everything the family needs": "Allt familjen behöver",
  "For you, and for everyone waiting by the phone": "För dig, och för alla som väntar vid telefonen",
  "See it in action": "Se hur det fungerar",
  "Click any stage to see how your page will look": "Klicka på ett steg för att se hur din sida kommer att se ut",
  "How it works": "Så fungerar det",
  "Get Started Free 🎉": "Kom igång gratis 🎉",
  "Join families who've already shared their special moments. Takes less than a minute.": "Gör som andra familjer och dela era speciella stunder. Det tar mindre än en minut.",
  "Update your status": "Uppdatera statusen",
  "One tap to update everyone — labour started, at the hospital, baby's here! No group texts, no repeated calls.": "Ett tryck uppdaterar alla — förlossningen har börjat, ni är på sjukhuset, bebisen är här! Inga gruppmeddelanden, inga upprepade samtal.",
  "Countdown to due date": "Nedräkning till beräknad födsel",
  'Everyone can see how many days are left — plus a friendly "overdue" counter when baby takes their time.': 'Alla kan se hur många dagar som är kvar — plus en vänlig "över tiden"-räknare om bebisen tar sin tid.',
  "Make it yours": "Gör den till din",
  "Pick a theme that matches your style. From soft pastels to bold colours — your page, your vibe.": "Välj ett tema som passar din stil. Från mjuka pasteller till starka färger — din sida, din känsla.",
  "No account needed": "Inget konto behövs",
  "Anyone with the link can check in anytime. Grandma doesn't need to download an app or create an account.": "Alla med länken kan kolla in när som helst. Mormor behöver inte ladda ner en app eller skapa ett konto.",
  "Send encouragement": "Skicka en hälsning",
  "Visitors can leave messages of love and support. Like a digital guestbook filled with well-wishes you'll treasure.": "Besökare kan lämna kärleksfulla hälsningar. Som en digital gästbok fylld med önskningar du kommer att värdesätta.",
  "Get notified": "Få notiser",
  "Family can subscribe to push notifications and be the first to know the moment baby arrives.": "Familjen kan prenumerera på pushnotiser och få veta först när bebisen kommer.",
  "Create your page": "Skapa din sida",
  "Share the link": "Dela länken",
  "Send it to family and friends. They can check in anytime and subscribe for notifications.": "Skicka den till familj och vänner. De kan kolla in när som helst och prenumerera på notiser.",
  "Update as you go": "Uppdatera längs vägen",
  "When things start happening, update your status. Everyone gets notified automatically.": "När det börjar hända saker uppdaterar du statusen. Alla får en notis automatiskt.",
  "At hospital": "På sjukhuset",
  "Baby born!": "Bebisen är född!",
  "Go Home": "Gå hem",
};
...
const es: Record<TranslationKey, string> = {
  ...
  "This removes the status and deletes its timeline update, including any message or photo attached to it. This cannot be undone.": "Esto quita el estado y elimina su novedad de la cronología, incluido cualquier mensaje o foto. No se puede deshacer.",
  "Delete status": "Eliminar estado",
  "Could not delete the {{status}} status": "No se pudo eliminar el estado {{status}}",
  "Pick a valid time — or leave it blank for now": "Elige una hora válida — o déjala en blanco por ahora",
  "When did it happen? (optional)": "¿Cuándo ocurrió? (opcional)",
  "Optional — leave blank for now. You can change the time later in settings.": "Opcional — déjalo en blanco por ahora. Puedes cambiar la hora más tarde en la configuración.",
  "Co-parents": "Copadres",
  "People who can post updates and change settings": "Personas que pueden publicar novedades y cambiar la configuración",
  "Others who can manage this page with you": "Otras personas que pueden gestionar esta página contigo",
  ...
  "The page will disappear from your dashboard and the public link will stop working. Only you (the owner) can do this.": "La página desaparecerá del panel y el enlace público dejará de funcionar. Solo tú (el propietario) puedes hacerlo.",
  "Loading co-parents…": "Cargando copadres…",
  "Co-parent added — they can manage this page now": "Copadre añadido — ya puede gestionar esta página",
  "Invite sent — they'll get access after signing up with that email": "Invitación enviada — tendrán acceso al registrarse con ese correo",
  ...
  "No co-parents yet. Add a partner so they can post updates too.": "Aún no hay copadres. Añade a tu pareja para que también pueda publicar novedades.",
  "Add": "Añadir",
  ...
  "Create an account to share your baby's arrival": "Crea una cuenta para compartir la llegada de tu bebé",
  ...
  "Is": "¿Ya nació",
  "out yet?": "?",
  'Stop answering "any news yet?" texts. Share one link, let everyone follow along, and tell them all at once when baby arrives. 🍼': 'Deja de responder "¿hay novedades?". Comparte un enlace, deja que todos sigan y avísales a todos a la vez cuando nazca el bebé. 🍼',
  "Create your page 🎈": "Crea tu página 🎈",
  "Everything the family needs": "Todo lo que la familia necesita",
  "For you, and for everyone waiting by the phone": "Para ti, y para todos los que esperan junto al teléfono",
  "See it in action": "Míralo en acción",
  "Click any stage to see how your page will look": "Haz clic en cualquier etapa para ver cómo se verá tu página",
  "How it works": "Cómo funciona",
  "Get Started Free 🎉": "Empieza gratis 🎉",
  "Join families who've already shared their special moments. Takes less than a minute.": "Únete a las familias que ya comparten sus momentos especiales. Tardarás menos de un minuto.",
  "Update your status": "Actualiza el estado",
  "One tap to update everyone — labour started, at the hospital, baby's here! No group texts, no repeated calls.": "Un toque informa a todos: comenzó el parto, estáis en el hospital, ¡el bebé llegó! Sin grupos ni llamadas repetidas.",
  "Countdown to due date": "Cuenta atrás para la fecha prevista",
  'Everyone can see how many days are left — plus a friendly "overdue" counter when baby takes their time.': 'Todos pueden ver cuántos días faltan — y un contador amable de "retraso" si el bebé se toma su tiempo.',
  "Make it yours": "Hazla tuya",
  "Pick a theme that matches your style. From soft pastels to bold colours — your page, your vibe.": "Elige un tema que vaya con tu estilo. De pasteles suaves a colores vivos: tu página, tu rollo.",
  "No account needed": "Sin necesidad de cuenta",
  "Anyone with the link can check in anytime. Grandma doesn't need to download an app or create an account.": "Cualquiera con el enlace puede entrar cuando quiera. La abuela no necesita descargar una app ni crear una cuenta.",
  "Send encouragement": "Enviar ánimo",
  "Visitors can leave messages of love and support. Like a digital guestbook filled with well-wishes you'll treasure.": "Los visitantes pueden dejar mensajes de cariño y apoyo. Como un libro de visitas digital lleno de buenos deseos.",
  "Get notified": "Recibe notificaciones",
  "Family can subscribe to push notifications and be the first to know the moment baby arrives.": "La familia puede suscribirse a notificaciones y enterarse en el momento en que llegue el bebé.",
  "Create your page": "Crea tu página",
  "Share the link": "Comparte el enlace",
  "Send it to family and friends. They can check in anytime and subscribe for notifications.": "Envíalo a familiares y amigos. Pueden entrar cuando quieran y suscribirse a las notificaciones.",
  "Update as you go": "Actualiza sobre la marcha",
  "When things start happening, update your status. Everyone gets notified automatically.": "Cuando empiece a pasar, actualiza el estado. Todo el mundo recibe un aviso automáticamente.",
  "At hospital": "En el hospital",
  "Baby born!": "¡El bebé ha nacido!",
...
const ptBR: Record<TranslationKey, string> = {
  ...
  "This removes the status and deletes its timeline update, including any message or photo attached to it. This cannot be undone.": "Isso remove o status e exclui a novidade da linha do tempo, incluindo mensagem ou foto. Não pode ser desfeito.",
  "Delete status": "Excluir status",
  "Could not delete the {{status}} status": "Não foi possível excluir o status {{status}}",
  "Pick a valid time — or leave it blank for now": "Escolha um horário válido — ou deixe em branco por enquanto",
  "When did it happen? (optional)": "Quando aconteceu? (opcional)",
  "Optional — leave blank for now. You can change the time later in settings.": "Opcional — deixe em branco por enquanto. Você pode alterar o horário depois nas configurações.",
  "Co-parents": "Copais",
  "People who can post updates and change settings": "Pessoas que podem publicar novidades e alterar as configurações",
  "Others who can manage this page with you": "Outras pessoas que podem gerenciar esta página com você",
  ...
  "The page will disappear from your dashboard and the public link will stop working. Only you (the owner) can do this.": "A página sumirá do painel e o link público deixará de funcionar. Só você (o responsável) pode fazer isso.",
  "Loading co-parents…": "Carregando copais…",
  "Co-parent added — they can manage this page now": "Copai adicionado — já pode gerenciar esta página",
  "Invite sent — they'll get access after signing up with that email": "Convite enviado — terão acesso depois de se cadastrar com esse e-mail",
  ...
  "No co-parents yet. Add a partner so they can post updates too.": "Ainda não há copais. Adicione um parceiro para que também possa publicar novidades.",
  "Add": "Adicionar",
  ...
  "Create an account to share your baby's arrival": "Crie uma conta para compartilhar a chegada do bebê",
  ...
  "Is": "O",
  "out yet?": "já nasceu?",
  'Stop answering "any news yet?" texts. Share one link, let everyone follow along, and tell them all at once when baby arrives. 🍼': 'Pare de responder "alguma novidade?". Compartilhe um link, deixe todos acompanharem e avise todo mundo de uma vez quando o bebê nascer. 🍼',
  "Create your page 🎈": "Crie sua página 🎈",
  "Everything the family needs": "Tudo o que a família precisa",
  "For you, and for everyone waiting by the phone": "Para você, e para todos que esperam ao telefone",
  "See it in action": "Veja na prática",
  "Click any stage to see how your page will look": "Clique em qualquer etapa para ver como sua página vai ficar",
  "How it works": "Como funciona",
  "Get Started Free 🎉": "Comece grátis 🎉",
  "Join families who've already shared their special moments. Takes less than a minute.": "Junte-se às famílias que já compartilham seus momentos especiais. Leva menos de um minuto.",
  "Update your status": "Atualize o status",
  "One tap to update everyone — labour started, at the hospital, baby's here! No group texts, no repeated calls.": "Um toque informa a todos — o trabalho de parto começou, a família está no hospital, o bebê chegou! Sem grupos ou ligações repetidas.",
  "Countdown to due date": "Contagem regressiva para a data prevista",
  'Everyone can see how many days are left — plus a friendly "overdue" counter when baby takes their time.': 'Todos podem ver quantos dias faltam — e um contador amigável de "atraso" se o bebê resolver demorar.',
  "Make it yours": "Deixe com a sua cara",
  "Pick a theme that matches your style. From soft pastels to bold colours — your page, your vibe.": "Escolha um tema que combine com seu estilo. De pastéis suaves a cores fortes — sua página, sua vibe.",
  "No account needed": "Não precisa de conta",
  "Anyone with the link can check in anytime. Grandma doesn't need to download an app or create an account.": "Qualquer pessoa com o link pode olhar a qualquer hora. A vovó não precisa baixar um aplicativo nem criar uma conta.",
  "Send encouragement": "Enviar carinho",
  "Visitors can leave messages of love and support. Like a digital guestbook filled with well-wishes you'll treasure.": "Visitantes podem deixar mensagens de carinho e apoio. Como um livro de visitas digital cheio de desejos que você vai guardar.",
  "Get notified": "Receba notificações",
  "Family can subscribe to push notifications and be the first to know the moment baby arrives.": "A família pode se inscrever para notificações e saber na hora em que o bebê nascer.",
  "Create your page": "Crie sua página",
  "Share the link": "Compartilhe o link",
  "Send it to family and friends. They can check in anytime and subscribe for notifications.": "Envie para familiares e amigos. Eles podem olhar a qualquer hora e se inscrever para notificações.",
  "Update as you go": "Atualize ao longo da jornada",
  "When things start happening, update your status. Everyone gets notified automatically.": "Quando as coisas começarem a acontecer, atualize o status. Todo mundo é avisado automaticamente.",
  "At hospital": "No hospital",
  "Baby born!": "O bebê nasceu!",
